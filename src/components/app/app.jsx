...
class App extends PureComponent {
  _renderGameScreen() {
    const {authorizationStatus, login, maxMistakes, mistakes, questions, onUserAnswer,
      onWelcomeButtonClick, resetGame, step} = this.props;
        ...
        case GameType.ARTIST:
          return (
            <GameScreen type={question.type}>
              <WrappedArtistQuestionScreen question={question} onAnswer={onUserAnswer} />
            </GameScreen>
          );
        case GameType.GENRE:
          return (
            <GameScreen type={question.type}>
              <WrappedGenreQuestionScreen question={question} onAnswer={onUserAnswer} />
            </GameScreen>
          );
      }
    }
